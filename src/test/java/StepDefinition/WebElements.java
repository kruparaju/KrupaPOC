...
public class WebElements {
	...
	static By username=By.xpath("//*[@id='ap_email']");
	static By useranameContinue=By.xpath("//*[@id='continue']");
	static By password=By.xpath("//*[@id='ap_password']");
	static By passwordContinue=By.xpath("//*[@id='signInSubmit']");
	static By SearchBox=By.xpath("//*[@id='twotabsearchtextbox']");
	...
	{
		FileInputStream fis =new FileInputStream("C:\\Users\\HOME\\Desktop\\loginmodule\\Configuration\\InputData.properties");
